...
pred inv15 {
 inv3 	all p1, p2:Person | 		(p2->p1 in Tutors and p2 in Student implies some p3:Person | p3->p2 in Tutors) 		and 		(p2->p1 in Tutors and p2 in Teacher implies not some p3:Person | p3->p2 in Tutors) 
}
