...
pred inv15 {
  	 	 all p1:Person | (p1 in Teacher implies (not some p2:Person| p2->p1 in Tutors)) and (some p2:Person | p2->p1 in Tutors and p2 not in Teacher and (some p3:Person | p3->p2 in Tutors)) 
}
