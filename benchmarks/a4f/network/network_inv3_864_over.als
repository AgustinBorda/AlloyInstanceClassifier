...
pred inv3 {
  	 	all user : univ | user in User and all photo : univ | user->photo in sees implies (photo in Ad) or (some follower : univ | follower in User and follower->photo in posts and user->follower in follows) 
}
