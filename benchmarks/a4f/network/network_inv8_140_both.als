...
pred inv8 {
  all disj u1,u2:User | u2 not in u1.follows implies u2.posts:>Ad not in u1.sees 	 all disj u1,u2:User | u2 not in u1.suggested implies u2.posts:>Ad not in u1.sees 
}
