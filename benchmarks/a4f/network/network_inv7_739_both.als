...
pred inv7 {
  	all x,x1:User | x1 in x.suggested implies some x2:User | x1 != x and x2 != x1 and x1 in x2.follows and x2 in x1.follows 	all x,x1:User | x in x1.suggested implies x not in x1.follows 
}
