...
pred inv7 {
  	 	all i: Influencer, u: User |i not in u.suggested 	all u: User | u in User.follows => u in User.suggested 	all u: User | not (u in User.follows) => not (u in User.suggested) 	all u: User | u not in u.suggested and u.follows not in u.suggested 
}
