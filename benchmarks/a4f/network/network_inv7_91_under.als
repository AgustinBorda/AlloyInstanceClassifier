...
pred inv7 {
  	all u1,u3 : User | u3 in u1.suggested implies (some u2 : User | u3 in u2.follows and u3 not in u1.follows and u2 in u1.follows) 	all u1,u2 : User | u1 in u2.suggested implies u1 != u2 
}
