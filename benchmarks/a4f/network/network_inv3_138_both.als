...
pred inv3 {
  	 	all u:User | some p: Photo - Ad | some x:User | (p in x.posts and p in u.sees) implies x in u.follows 	all a:Ad | some i:User | all u:User - i | a in u.sees and a in i.posts 
}
