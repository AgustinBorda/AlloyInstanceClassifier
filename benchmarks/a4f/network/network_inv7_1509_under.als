...
pred inv7 {
  all u1,u2 : User | u2 in u1.suggested implies u1 != u2 	all u1,u2 : User | u2 in u1.suggested implies u2 not in u1.follows 	all u1,u2 : User | u2 in u1.suggested implies u2 in u1.follows.follows 
}
