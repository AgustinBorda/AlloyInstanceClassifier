...
pred inv3 {
  	 	all u, j : User | all p : Photo-Ad | u -> p in sees implies u -> j in follows and j -> p in posts 	 	all u : User | u.sees-Ad in u.follows.posts 	 	all u : User | all a : Ad | u -> a in sees 	 
}
