...
pred inv3 {
  	 	all u:User | some p: Photo - Ad | some x:User | (p in x.posts and p in u.sees) implies x in u.follows all u:User | all p: Photo | p in u.posts implies p not in u.sees 
}
