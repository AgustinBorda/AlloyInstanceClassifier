...
pred inv7 {
  	all usr1, usr2, usr3 : User 		|	usr1->usr2 in follows 			and usr2->usr3 in follows 			and usr1->usr3 not in follows implies usr1->usr3 in suggested all usr1, usr2, usr3 : User 		|	usr1->usr2 in follows 			and usr2->usr3 in follows 			and usr1->usr3 in follows implies usr1->usr3 not in suggested 	 
}
