...
pred inv8 {
  all a:Ad | all u,u2:User | a in u2.posts and (u2 in u.follows or u2 in u.suggested) implies a in u.sees all a:Ad | all u:User | a in u.sees implies some u2:User | a in u2.posts and (u2 in u.suggested or u2 in u.follows) all u:User | all p:Ad | p in u.sees implies p not in u.posts 
}
