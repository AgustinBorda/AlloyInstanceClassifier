...
pred inv4 {
  all u:User, p : Photo | p in Ad and u->p in posts implies (all ph : Photo | u->ph in posts implies ph in Ad) all u:User| u.posts in Ad implies (all p : Photo | posts.p in Ad) 
}
