...
pred inv3 {
  	 all user : User, photo : Photo | (photo in user.sees) implies (photo = Ad) or (all followed : univ | (followed in User) and (followed->photo in posts) implies (user->followed in follows)) 
}
