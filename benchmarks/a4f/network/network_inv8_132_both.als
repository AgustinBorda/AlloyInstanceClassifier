...
pred inv8 {
  all u1,u2:User | u1 != u2 and u2 not in u1.follows implies u2.posts:>Ad not in u1.sees 	 all u1,u2:User | u1 != u2 and u2 not in u1.suggested implies u2.posts:>Ad not in u1.sees 
}
