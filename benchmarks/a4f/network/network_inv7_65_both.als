...
pred inv7 {
  	 all u: User - Influencer| u.suggested in u.follows.follows => u.suggested not in u.follows all u:User | u not in u.suggested all i: Influencer, u: User| i not in u.suggested 
}
