...
pred inv3 {
  	 all p:Photo | all u:User,u2:User | p in u.sees and p in u2.posts implies u2 in u.follows all p:Photo | all u:User | p in u.sees implies p not in u.posts all p:Photo | all u:Influencer | p in u.sees implies p not in u.posts 
}
