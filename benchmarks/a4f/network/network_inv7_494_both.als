...
pred inv7 {
  	 all u:User | u not in u.suggested all i: Influencer, u: User |i not in u.suggested all i: Influencer| none in i.suggested all u: User| u.follows.follows in u.suggested 
}
