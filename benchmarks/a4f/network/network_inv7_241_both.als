...
pred inv7 {
  	all disj u,uu: User| u in uu.follows.follows and u not in uu.follows => u in uu.suggested all u: User | u.suggested in u.follows.follows and u.suggested not in u.follows 
}
