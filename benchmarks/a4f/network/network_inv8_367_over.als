...
pred inv8 {
  	all u : User | u.sees & Ad = u.follows.posts + u.suggested.posts & Ad all u:User | all a:Ad | a in u.sees implies some p:User | a in p.posts and p in (u.follows + u.suggested) 
}
