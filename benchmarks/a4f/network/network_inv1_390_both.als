...
pred inv1 {
  	 	all p: Photo | some u : User | p in u.posts 	all a : Ad| some u : User | a in u.posts 	all p: Photo | some i : Influencer | p in i.posts 	all a : Ad| some i : Influencer | a in i.posts 	 
}
