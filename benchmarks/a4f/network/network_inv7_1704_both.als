...
pred inv7 {
  	all u1, u2, u3 : User | (u2 not in u1.follows and u3 in u1.follows and u2 in u3.follows) implies u2 in u1.suggested 	all u : User | u not in u.suggested 	all u : User | all i : Influencer | i not in u.suggested 	all u1, u2 : User | u1 not in u2.^follows implies u1 not in u2.suggested 
}
