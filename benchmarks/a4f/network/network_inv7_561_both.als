...
pred inv7 {
  all u1, u2 : User | (u2 not in Influencer and u2 not in u1.follows and u2 in u1.^follows and u1 != u2) implies u2 in u1.suggested all u1 : User | u1 not in u1.suggested 
}
