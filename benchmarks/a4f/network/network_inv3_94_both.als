...
pred inv3 {
  	 all u1, u2 : User | all ph : Photo | ph in u1.posts and ph in u2.sees implies u1 in u2.follows and u1 != u2 all u1, u2 : User | all ph : Photo | some ad : Ad | ph in u1.sees and ph in u2.posts and u1 not in follows.u2 implies ph = ad 
}
