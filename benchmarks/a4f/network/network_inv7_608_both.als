...
pred inv7 {
  	all u, v,w: User| u in Influencer and v in Influencer and u->v in follows and u->w not in follows implies v->u in suggested and v->w in suggested and u!=v and u!=w 	 
}
