...
pred inv7 {
  	all u : User | all s : u.suggested | s in u.follows.follows and s not in u.follows and u not in s 	all u : User | all u2 : User | u in u2.suggested implies ( u not in u2.follows and u in u2.follows.follows and u != u2) 	 	 
}
