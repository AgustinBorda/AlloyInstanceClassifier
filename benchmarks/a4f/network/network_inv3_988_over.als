...
pred inv3 {
  	 	all u : User | all p : Photo-Ad | u->p in sees implies p in u.follows.posts 	all u : User | all p : Photo | all a : Ad | u->a in posts and u->p in posts implies u.posts in Ad 
}
