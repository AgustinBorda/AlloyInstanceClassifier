...
pred inv1 {
  	all y : univ | y in Photo implies some x : User | x.posts=y 	all x,y,z : univ | x in User and z in User and y in Photo and x->y in posts and z->y in posts implies x=z 
}
