...
pred inv7 {
  	 	 	all user1, user2, user3 : User | 		user1->user2 in follows and user2->user3 in follows and user1->user3 not in follows implies user1->user3 in suggested 	 	 	all user1, user2, user3 : User | 		user1->user2 in follows and user2->user3 in follows and user1->user3 in follows implies user1->user3 not in suggested 	 
}
