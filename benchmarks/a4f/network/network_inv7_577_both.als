...
pred inv7 {
  all u1, u2, u3 : User | ((u1 in follows.u2) && (u2 in follows.u3)) implies (u1 in suggested.u3)	 all u : User | u not in suggested.u all u1, u2 : User | (u1 in follows.u2) implies (u1 not in suggested.u2) 
}
