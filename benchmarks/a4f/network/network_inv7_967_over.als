...
pred inv7 {
  	all u:User | u->u not in suggested 	all u1, u2, u3: User | u1 != u2 and u1!=u3 and u1->u2 in follows and u2->u3 in follows and u1->u3 not in follows <=> u1->u3 in suggested 
}
