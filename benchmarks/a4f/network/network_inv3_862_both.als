...
pred inv3 {
  	 	all user1, user2: User | all photo: Photo | (photo in user1.sees and photo in user2.posts) implies user2 in user1.follows all ad : Ad | ad in User.sees and ad in User.posts 
}
