...
pred inv3 {
  	 	all p : Photo, u1,u2 : User | p != Ad and p in u1.sees implies p in u2.posts and u2 in u1.follows 	all p : Photo, u : User | p in u.posts implies p not in u.sees 	all ad : Ad, u : User | ad in u.sees 
}
