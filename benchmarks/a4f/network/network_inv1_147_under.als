...
pred inv1 {
  	 	all p : univ | p in Photo implies some u : univ | u in User and u->p in posts 	all p : univ | some u1, u2 : univ | p in Photo and u1->p in posts and u2->p in posts implies u1 = u2 
}
