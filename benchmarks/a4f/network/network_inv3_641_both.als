...
pred inv3 {
  	 	all p : Photo, u1,u2 : User | p in u2.posts and u2 in u1.follows and p != Ad implies p in u1.sees 	 	all ad : Ad, u1,u2 : User | ad in u1.sees implies ad in u2.posts and u2 not in u1.follows or u2 in u1.follows 	 	 	 
}
