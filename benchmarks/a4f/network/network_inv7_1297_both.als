...
pred inv7 {
  	all u, v,w: User| u not in u.follows and v not in v.follows and u->v in follows and u->w not in follows implies v->u in suggested and v->w in suggested and u!=v and u!=w 	 
}
