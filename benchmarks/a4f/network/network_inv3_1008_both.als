...
pred inv3 {
  	 	all a : Ad | one u : Influencer | u->a in posts 	all a,b : User | all p : Photo | a->b in follows implies a->p in sees 	all a,b : User | all p : Photo | b->a in follows implies b->p in sees 
}
