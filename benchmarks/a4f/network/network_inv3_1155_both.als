...
pred inv3 {
  	 	all ad: Ad | ad in User.sees and ad not in User.posts 	all photo: Photo | all user1, user2: User | photo in user1.sees and photo in user2.posts implies user2 in user1.follows 
}
