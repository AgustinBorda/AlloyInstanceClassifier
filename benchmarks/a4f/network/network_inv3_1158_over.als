...
pred inv3 {
  	 	all user : univ | user in User and some photo : univ | user->photo in posts implies (photo in Ad) or (some follower : univ | follower->photo in posts and user->follower in follows) 
}
