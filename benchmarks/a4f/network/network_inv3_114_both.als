...
pred inv3 {
  	 all p:Photo | all u:User | p in u.sees implies p not in u.posts all p:Photo | all u:User,u2:User | u != u2 and p in u.sees and p in u2.posts and p not in Ad implies u2 in u.follows 
}
