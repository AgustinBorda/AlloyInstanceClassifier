...
pred inv3 {
  	 	all p : Photo | all u1 : User-Influencer | all u2 : User | all i : Influencer | 		 (p in u1.sees implies ((p in u2.posts and u2 in u1.follows and p not in Ad) or (p in Ad))) or (p in u1.sees implies p in i.posts) 
}
