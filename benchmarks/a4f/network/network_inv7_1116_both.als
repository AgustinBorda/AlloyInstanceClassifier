...
pred inv7 {
  	all user: User | user not in user.suggested 	all user1, user2: User | user2 in user1.follows.follows and user2 not in user1.follows implies user2 in user1.suggested 
}
