...
pred inv7 {
  	all disj u,uu: User- Influencer| u in uu.follows.follows and u not in uu.follows => u in uu.suggested all u:User | u not in u.suggested all i: Influencer | none in i.suggested 
}
