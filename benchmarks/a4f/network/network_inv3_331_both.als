...
pred inv3 {
  	 all user1, user2 : User | all photo : Photo | (photo in user1.posts and photo in user2.sees) implies user1 in user2.follows some user : User | all ad : Ad | ad in user.sees 
}
