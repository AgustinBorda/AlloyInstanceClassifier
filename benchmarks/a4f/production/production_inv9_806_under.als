...
pred inv9 {
  	all w : Workstation | w not in w.^succ 	all w : Workstation | w in begin => no succ.w 	all w : Workstation | w in end => no w.succ 	all w : Workstation | (w not in begin + end) => one w.succ 
}
