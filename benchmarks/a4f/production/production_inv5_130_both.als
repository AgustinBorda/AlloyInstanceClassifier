...
pred inv5 {
  	all ws: Workstation| some w: Worker | w in Human and w in ws.workers => ws.workers not in Robot 	all ws: Workstation |some w: Worker | w in Robot and w in ws.workers => ws.workers not in Human 
}
