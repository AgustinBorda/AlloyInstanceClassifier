...
pred inv9 {
  	all w : Workstation-end | one w.succ 	all w : Workstation | w not in w.^succ 	one begin 	one end 	no end.succ 	no begin & Workstation.succ 	no begin & end 	all w : Workstation | w in begin.^succ	 
}
