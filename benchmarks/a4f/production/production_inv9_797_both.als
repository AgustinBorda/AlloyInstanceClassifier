...
pred inv9 {
  	no end.succ	 	no W:Workstation | W in W.succ 	no W:Workstation | begin in W.succ 	all W:Workstation-end | one W.succ 	all W:Workstation-begin | one W2:Workstation-begin-W | W in W2.succ 	 	 	 	 	 
}
