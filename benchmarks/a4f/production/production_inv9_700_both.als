...
pred inv9 {
 all x,y:Workstation| x in y.succ implies y not in x.succ all x,y:Workstation| x in y.succ implies #(y.succ) > #(x.succ) all x,y:Workstation| x in y.^succ implies y not in y.^succ 	 
}
