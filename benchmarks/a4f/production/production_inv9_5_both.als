...
pred inv9 {
  	no end.succ+succ.begin one succ.end one begin.succ all w : Workstation | w not in begin&end all w : Workstation-end-begin | one w.succ && one succ.w && w.succ != succ.w 
}
