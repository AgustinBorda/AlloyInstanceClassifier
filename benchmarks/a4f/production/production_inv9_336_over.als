...
pred inv9 {
  	one w : Workstation | w in end and no w.succ one w : Workstation | w in begin and w not in Workstation.succ 	all w : Workstation | one wb : begin | w!=wb and w in wb.^(succ) 
}
