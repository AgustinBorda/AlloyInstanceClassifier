...
pred inv5 {
  	all ws : Workstation | some h : Human | h in ws.workers implies no ws.workers&Robot 	all ws : Workstation | some r : Robot | r in ws.workers implies no ws.workers&Human 
}
