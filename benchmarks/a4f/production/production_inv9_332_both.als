...
pred inv9 {
  	one Workstation & begin 	one Workstation & end 	begin not in Workstation.^succ 	end not in ^succ.Workstation 	all w : Workstation | one w & (^succ.Workstation + Workstation.^succ) 
}
