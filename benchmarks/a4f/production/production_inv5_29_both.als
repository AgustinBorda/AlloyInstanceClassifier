...
pred inv5 {
  	all wb : Workstation | some r : Robot | some h : Human | (r in wb.workers) implies (h not in wb.workers) 	all wb : Workstation | some r : Robot | some h : Human | (h in wb.workers) implies (r not in wb.workers) 
}
