...
pred inv2 {
  	all w1,w2 : Worker | all ws1,ws2: Workstation | ws1!=ws2 and w1 in ws1.workers and w2 in ws2.workers implies w1!=w2 	all ws : Workstation | some Workstation.workers 	all w : Worker | w in Workstation.workers 
}
