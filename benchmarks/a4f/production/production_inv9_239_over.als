...
pred inv9 {
  	all ws : Workstation | ws=begin implies ws!=end 	all ws : Workstation | ws = end implies ws != begin 	all b : begin | b not in Workstation.succ 	all ws : Workstation | ws not in ws.^succ 	all ws : Workstation | all e : end | e in ws.^succ 
}
