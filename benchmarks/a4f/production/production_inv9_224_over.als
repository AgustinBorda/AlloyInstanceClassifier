...
pred inv9 {
  	all ws : Workstation | ws in begin implies ws not in end 	all ws : Workstation | ws in end implies ws not in begin 	all b : begin | b not in Workstation.succ 	all ws : Workstation | ws not in ws.^succ 	all ws : Workstation | all e : end | e in ws.^succ 
}
