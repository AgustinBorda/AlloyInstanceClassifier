...
pred inv10 {
  	all x:Component | x.parts.workstation != x.workstation 	all x:Component | x.parts.workstation.succ in x.workstation or x.parts.workstation.succ in x.parts.workstation 
}
