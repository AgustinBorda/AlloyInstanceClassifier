...
pred inv9 {
  	one w : Workstation | w in end and no w.succ one w : Workstation | w in begin and w not in Workstation.succ 	all w : Workstation | one wb : Workstation | (wb in begin and w!=wb) implies w in wb.^(succ) 
}
