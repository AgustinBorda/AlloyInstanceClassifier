...
pred inv2 {
  	all wb : Workstation | some (wb.workers & Worker) 	all w : Worker | one (w & Workstation.workers) 	all wb1,wb2 : Workstation | all w : Worker | (w in wb1.workers) implies (w not in wb2.workers) 
}
