...
pred inv9 {
  	(all w1:Workstation, w2:Workstation | (w1 in begin and w1!=w2) implies w1 in w2.succ) 	and 	(all w: Workstation | w not in w.succ) 	and 	(all w:Workstation | w not in end implies one w.succ) 
}
