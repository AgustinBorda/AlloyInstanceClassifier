...
pred inv5 {
  	all wb : Workstation | one r : Robot | one h : Human | (r in wb.workers) implies (h not in wb.workers) 	all wb : Workstation | one r : Robot | one h : Human | (h in wb.workers) implies (r not in wb.workers) 
}
