...
pred inv9 {
  all w : Workstation | w in begin implies Workstation-{w} in w.^(succ) all w : Workstation | w not in w.^(succ) all w,w1 : Workstation | w in end and w!=w1 implies (w1 not in w.^(succ)) 
}
