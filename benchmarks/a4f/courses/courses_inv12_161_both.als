...
pred inv12 {
  	all s : Student | all c : Course | c in s.enrolled implies s in c.grades.Grade 	all s1,s2 : Student | all c : Course | s1 in c.grades.Grade and s2 in c.grades.Grade implies s1 != s2 
}
