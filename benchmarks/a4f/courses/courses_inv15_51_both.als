...
pred inv15 {
  	all disj s, s1 : Student, p : s.projects & s1.projects | one s.((projects.p <: Course).grades) and 	one s.((projects.p <: Course).grades) and ( 	s.((projects.p <: Course).grades) = next[s1.((projects.p <: Course).grades)] or 	s.((projects.p <: Course).grades) = prev[s1.((projects.p <: Course).grades)] or 	s.((projects.p <: Course).grades) = s1.((projects.p <: Course).grades)) 	 
}
