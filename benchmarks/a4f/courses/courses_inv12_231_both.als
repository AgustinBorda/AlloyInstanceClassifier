...
pred inv12 {
  	all p: Student | all g : Grade | g != none implies p->g in Course.grades 	all s1,s2 : Student | all g1,g2 : Grade | all c : Course | s1->g1 in c.grades and s2->g2 in c.grades implies s1 != s2 
}
