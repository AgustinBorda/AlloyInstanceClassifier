...
pred inv9 {
  	all c : Course, disj p0,p1 : Professor | c in p0.teaches => c not in p1.enrolled all c : Course, disj p0,p1 : Professor | c in p0.enrolled and c in p1.enrolled => c not in p0.teaches and c not in p1.teaches 
}
