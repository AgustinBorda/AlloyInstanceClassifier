...
pred inv5 {
  	 	all x, y : univ | x in Person and y in Project and x->y in Person<:projects implies x in Student all x,y : univ | x->y in Person<:projects implies x in Student and x not in Professor all x : univ | x in Project implies some y : Student | y->x in Person<:projects 
}
