...
pred inv9 {
  	all p1, p2 : Professor | all c : Course | c in p1.teaches and c in p2.teaches and p1!=p2 implies c not in p1.enrolled and c not in p2.enrolled 	all p1, p2 : Professor | all c : Course | c in p1.teaches and c in p2.teaches and p1!=p2 implies all c2 : Course | c2 not in p1.enrolled and c2 not in p2.enrolled 	 
}
