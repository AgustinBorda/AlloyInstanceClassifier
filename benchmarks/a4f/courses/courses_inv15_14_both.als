...
pred inv15 {
  	all p : Project | all s1, s2 : Student | s1->p in projects and s2->p in projects and s1 != s2 => 	( all g1, g2: Grade, c : Course | c->s1->g1 in grades and c->s2->g2 in grades => (g1 = g2 or g1 = g2.prev or g2 = g1.prev) ) 
}
