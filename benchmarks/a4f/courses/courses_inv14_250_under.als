...
pred inv14 {
  	all s1:Student, s2:Student, p1:Project, p2:Project | 	(p1 in s1.projects and p2 in s1.projects and s1!=s2 and p1!=p2) implies (s1 not in p2.projects and s2 not in p1.projects) 
}
