...
pred inv14 {
  	all s1,s2 : Student | all p1,p2 : Project | 	(s1->p1 in projects and s2->p1 in projects and s1!=s2) implies 	( (s1->p2 not in projects) or (s2->p2 not in projects) and s1!=s2) 
}
