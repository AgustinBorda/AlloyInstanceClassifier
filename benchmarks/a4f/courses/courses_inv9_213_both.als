...
pred inv9 {
  	all c: Course | one p : Professor | c in p.teaches 	all p : Person-Student | all person : Person | (p.enrolled&person.enrolled != none) implies (p.teaches&person.enrolled = none and p!=person) 
}
