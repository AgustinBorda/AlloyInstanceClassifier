...
pred inv5 {
  	 	all p: Person, proj: Project, c: Course | proj in p.projects and c in p.enrolled implies p in Student and proj in c.projects 	all proj: Project | some (Course <: projects).proj 
}
