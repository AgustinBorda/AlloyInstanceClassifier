...
pred inv13 {
  	all c1 : Course | all g1 : Grade | all s1 : Student | 	c1->s1->g1 in grades and (one g2 : Grade|g2=max[g1]) implies (some p1 : Project | c1->p1 in projects and s1->p1 in projects) 
}
