...
pred inv1 {
  	all c1 : Course | all g1 : Grade | all s1 : Student | one g2 : Grade | one s2 : Student | 	c1->s1->g1 in grades and c1->s2->g2 in grades and g2=max[g1] 	implies (some p1 : Project | c1->p1 in projects and s2->p1 in projects) 
}
