...
pred inv15 {
  	all disj s1, s2 : Student | 		all g1 : s1.(Course.grades) | 			all g2 : s2.(Course.grades) | 				(some (s1.projects & s2.projects) and some g1 and some g2 )implies (g2 in g1.prev or g1 in g2.prev or g1 = g2) 
}
