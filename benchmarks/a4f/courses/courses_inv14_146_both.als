...
pred inv14 {
  	 	 	all s1,s2:Student | one p:Project | s1->p in projects and s2->p in projects implies all ps:Project-p | s1->ps in projects and s2->ps not in projects 	all s1,s2:Student | one p:Project | s1->p in projects and s2->p in projects implies all ps:Project-p | s2->ps in projects and s1->ps not in projects 	 
}
