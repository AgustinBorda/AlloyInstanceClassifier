...
pred inv14 {
  	 	all s1,s2:Student, p:Project | p in s1.projects and p in s2.projects implies all ps:Project-p | ps in s1.projects and ps not in s2.projects 	all s1,s2:Student, p:Project | p in s1.projects and p in s2.projects implies all ps:Project-p | ps not in s1.projects and ps in s2.projects 
}
