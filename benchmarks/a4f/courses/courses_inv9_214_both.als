...
pred inv9 {
  	all p,a : Professor | all c1,c2 : Course | p->c1 in teaches and a->c1 in enrolled and a->c2 in teaches implies p->c2 not in enrolled 	all p,a : Professor | no (p.teaches & a.enrolled) 	 
}
