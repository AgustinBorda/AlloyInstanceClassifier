...
pred inv12 {
  	all c : Course | all g: Grade | g in c.grades.Person implies c.grades.Grade != none 	all s1,s2 : Student | all c : Course | s1 in c.grades.Grade and s2 in c.grades.Grade implies s1 != s2 
}
