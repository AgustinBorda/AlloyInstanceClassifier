...
pred inv7 {
  	all t:Track | t not in t.succs all disj t1,t2 : Track | (t1 in t2.succs => t2 not in t1.succs) and t2.succs not in t1.succs 	all disj ex:Exit, e:Entry, j:Junction | no ex.succs and e not in j.succs 
}
