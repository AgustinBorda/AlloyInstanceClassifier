...
pred inv7 {
  	all t:Track | t not in Exit implies some t2:Track | t->t2 in succs 	all t:Track | t in Exit implies all t2:Track | t->t2 not in succs 	all t:Track | t not in Entry implies some t2:Track | t2->t in succs 	all t:Track | t in Entry implies all t2:Track | t2->t not in succs 
}
