...
pred inv5 {
  	 	all t1,t2,t3:Track | t1 in t2.succs and t1 in t3.succs and t1!=t2 and t1!=t3 implies one (Junction & t1) 	all t1:Track | lone (t1 & Track.succs) implies no (Junction & t1) 
}
