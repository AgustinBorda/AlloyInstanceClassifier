...
pred inv15 {
 all p1 : Person | some p2, p3 : Person | (p1 != p2) and (p1 != p3) and (p2 != p3) and (all p4 : Person | (p4 = p1) or (p4 = p2) or (p4 = p3)) and ( (p2->p1 in Tutors and p2 in Teacher) or (p3->p2 in Tutors and p2->p1 in Tutors and p3 in Teacher) or (p1->p3 in Tutors and p3->p2 in Tutors and p2->p1 in Tutors and p1 in Teacher)) 
}
